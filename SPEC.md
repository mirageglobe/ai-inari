...
### Near-term
- none open; all measured hot-path work has landed (P2 render cache) or was found already done on re-check (P3 memoise, commit 531359a). next candidates are in Ideas.
