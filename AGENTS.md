...
- Always read `README.md`, `AGENTS.md`, and `SPEC.md` at the start of a session for project context.
...
Target model sizes for 2026 1-bit models:
...
- Run `go test ./...` to verify no regressions before committing.
- If `go vet`, `go build`, or `go test` fail, fix the errors before proceeding.
